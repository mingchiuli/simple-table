...
function guardDocumentCommandBus(
  ...
  return {
    ...
    insertImage: operations.guard(commandBus.insertImage, undefined),
    updateImage: operations.guard(commandBus.updateImage, undefined),
    deleteImage: operations.guard(commandBus.deleteImage, undefined),
